CREATE TABLE IF NOT EXISTS `#__pmenu_books` (
...
CREATE TABLE IF NOT EXISTS `#__pmenu_libraries` (
...
CREATE TABLE IF NOT EXISTS `#__pmenu_waitlists` (
...
CREATE TABLE IF NOT EXISTS `#__pmenu_wishlists` (
...
CREATE TABLE IF NOT EXISTS `#__pmenu_reviews` (
