...
<h3>
	<span class="label label-info pull-right"><?php echo $this->stats['total_items']; ?></span>
	<?php echo JText::_('COM_PMENU_STATISTICS_TOTAL_BOOKS'); ?>
</h3>
<div class="progress progress-success">
  <div class="bar" style="width: <?php echo $this->stats['total_items'] > 100 ? $this->stats['total_items'] / 100 : $this->stats['total_items']; ?>%"></div>
</div>
<p><?php echo JText::_('COM_PMENU_STATISTICS_TOTAL_BOOKS_DESC'); ?></p>
</div>

<!--<div class="span4 thumbnail">
<h3>
	<span class="label label-info pull-right"><?php //echo $this->stats['total_reviews']; ?></span>
	<?php echo JText::_('COM_PMENU_STATISTICS_TOTAL_REVIEWS'); ?>
</h3>
<div class="progress progress-success">
...
<h3>
	...
	<?php echo JText::_('COM_PMENU_STATISTICS_AVG_WISHLIST'); ?>
</h3>
